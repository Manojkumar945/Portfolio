              ...
              <div className="flex gap-4">
               <a 
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="bg-gradient-to-r from-black-600 to-black-700 hover:from-black-700 hover:to-black-800 p-4 rounded-xl text-white transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
