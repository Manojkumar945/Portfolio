        ...
        <div className="flex flex-col md:flex-row gap-12 items-center">
          <div className="w-full md:w-1/2">
            ...
            <div className="flex flex-wrap gap-6 mt-10">
              <div className="flex flex-col items-center justify-center p-6 bg-gradient-to-br from-slate-700 to-slate-800 rounded-xl w-40 border border-slate-600 hover:border-amber-400/50 transition-all duration-300 group">
                <span className="text-4xl font-bold text-amber-400 group-hover:scale-110 transition-transform">5+</span>
                <span className="text-slate-400 text-sm font-medium">Internships</span>
              </div>
              <div className="flex flex-col items-center justify-center p-6 bg-gradient-to-br from-slate-700 to-slate-800 rounded-xl w-40 border border-slate-600 hover:border-amber-400/50 transition-all duration-300 group">
                <span className="text-4xl font-bold text-amber-400 group-hover:scale-110 transition-transform">8+</span>
          ...
          <div className="w-full md:w-1/2">
            <div className="bg-gradient-to-br from-slate-700 to-slate-800 p-8 rounded-2xl shadow-2xl border border-slate-600">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={index} className="bg-slate-800 p-5 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-slate-600 hover:border-amber-400/30 group">
                    <h4 className="font-semibold text-white mb-2 group-hover:text-amber-400 transition-colors">{strength.title}</h4>
