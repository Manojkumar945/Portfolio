    ...
    >
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col items-center mb-16">
          <h2 className={`text-4xl font-bold mb-4 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Skills & Certifications</h2>
          <div className="flex items-center gap-4 mb-6">
            ...
            <div className={`w-3 h-3 rounded-full ${isDarkMode ? 'bg-cyan-400' : 'bg-blue-600'}`} />
          ...
          <div>
            ...
            <div className="relative w-full h-96 flex items-center justify-center py-12">
              ...
              <div className={`absolute w-24 h-24 rounded-full flex items-center justify-center ${
                isDarkMode ? 'bg-gradient-to-br from-cyan-500/30 to-blue-500/30 border-2 border-cyan-400/50' : 'bg-gradient-to-br from-blue-300/30 to-cyan-300/30 border-2 border-blue-400/50'
              }`}>
                      ...
                      <div className="skill-item">
                        <div className="flex flex-col items-center gap-2 group cursor-pointer">
                          <div className={`w-20 h-20 rounded-xl flex items-center justify-center transition-all duration-300 hover:scale-125 backdrop-blur-sm ${
                            isDarkMode ? 'bg-slate-800/60 border border-slate-600/50 hover:border-cyan-400/50 shadow-lg' : 'bg-white/60 border border-gray-200 hover:border-cyan-400/50 shadow-lg'
                          }`}>
                    ...
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          <h4 className={`font-bold text-lg group-hover:text-purple-400 transition-colors ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>{cert.name}</h4>
        ...
        {/* ── Awards & Achievements ── */}
        <div className="mt-20 border-t pt-20" style={{ borderColor: isDarkMode ? 'rgba(100,116,139,0.3)' : 'rgba(59,130,246,0.3)' }}>
          <div className="flex flex-col items-center mb-16">
            <div className="flex items-center gap-3 mb-4">
              <div className="p-3 bg-gradient-to-r from-cyan-500 to-blue-500 rounded-xl shadow-lg">
                <Trophy size={28} className="text-white" />
              </div>
              <h2 className={`text-3xl sm:text-4xl font-bold ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>Awards & Achievements</h2>
            </div>
            <div className="flex items-center gap-4 mb-6">
              <div className={`h-px w-16 ${isDarkMode ? 'bg-gradient-to-r from-transparent to-cyan-400' : 'bg-gradient-to-r from-transparent to-blue-600'}`} />
              <div className={`w-3 h-3 rounded-full ${isDarkMode ? 'bg-cyan-400' : 'bg-blue-600'}`} />
          ...
          <div className="max-w-5xl mx-auto space-y-8">
            ...
            {/* ── Award 1: Techfinix-25 — Left: content + prize, Right: money visual ── */}
            <div className="group">
            ...
            <div className="group">
              <div className={`rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-2xl group-hover:-translate-y-1 ${
                ...
                <div className="p-5 sm:p-8">
                  ...
                  {/* Center image — full width, no crop, clickable lightbox */}
                  <div
      ...
      {selectedCertificate && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
          <div className={`relative max-w-5xl max-h-[95vh] w-full rounded-2xl shadow-2xl overflow-hidden ${isDarkMode ? 'bg-slate-900' : 'bg-white'}`}>
            <div className={`flex items-center justify-between p-6 ${isDarkMode ? 'bg-slate-800' : 'bg-gray-50'}`}>
              ...
              <button onClick={closeCertificate} className={`p-2 rounded-full transition-all duration-300 hover:scale-110 ${isDarkMode ? 'bg-slate-700/50 hover:bg-slate-600/50 text-slate-300 hover:text-white' : 'bg-gray-100/50 hover:bg-gray-200/50 text-gray-600 hover:text-gray-900'}`}>
                <X size={24} />
              </button>
            </div>
