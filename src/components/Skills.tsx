...
const certifications = [
  { 
    ...
    description: "Published a research paper titled as “Brainwave Monitoring and Stress Alert System with AI Smart Therapy” at Journal of IoT in Social, Mobile, Analytics and Cloud (JISMAC)."
  },
  { 
...
{/* Circular Rotating Skills Container */}
<div className="relative w-full h-96 flex items-center justify-center py-12">
  ...
  {/* Center Circle */}
  <div className={`absolute w-24 h-24 rounded-full flex items-center justify-center transition-all duration-700 ${
    isDarkMode
    ...
    <div className={`text-3xl font-bold transition-colors duration-700 ${
  ...
  {/* Orbital Ring */}
  <div className={`absolute w-80 h-80 rounded-full border border-dashed transition-colors duration-700 ${
    isDarkMode
      ? 'border-cyan-400/20'
      : 'border-blue-400/20'
  }`}></div>
