                ...
                <div className="flex flex-col sm:flex-row">
                  <div className="flex-1 p-5 sm:p-8">
                    ...
                    <div className="grid grid-cols-3 gap-2 sm:gap-3 mb-4">
                      ...
                      <div className={`rounded-xl p-2 sm:p-3 text-center ${dm ? 'bg-slate-700/60 border border-slate-600/30' : 'bg-blue-50 border border-blue-100'}`}>
                        <p className={`text-base sm:text-lg font-bold ${dm ? 'text-white' : 'text-gray-900'}`}>Pages 15 - 39</p>
                    ...
                    <div className="flex flex-wrap items-center gap-3">
                      ...
                      <a
                        ...
                        className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold text-white bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 transition-all shadow hover:shadow-lg"
                      >
                      ...
                      <button
                        ...
                        className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold transition-all shadow hover:shadow-lg ${dm ? 'bg-slate-700 hover:bg-slate-600 text-slate-200 border border-slate-500' : 'bg-white hover:bg-gray-50 text-gray-700 border border-gray-200'}`}
                      >
                ...
                <div className="p-5 sm:p-8">
                  ...
                  <div className="grid grid-cols-3 gap-2 sm:gap-3 mb-5">
                    ...
                    <div className={`rounded-xl p-2 sm:p-3 text-center ${dm ? 'bg-slate-700/60 border border-slate-600/30' : 'bg-blue-50 border border-blue-100'}`}>
                      ...
                      <p className={`text-xs ${dm ? 'text-slate-400' : 'text-gray-500'}`}>Dept.</p>
                    </div>
                  </div>
